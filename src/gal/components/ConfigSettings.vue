...
.config-background {
  ...
  width: 100%;
  height: 100%;
  background-image: url('https://amakano3.yorino.space/menu/config/sy_bg.webp');
...
.tab-btn {
  ...
  // 各个标签的背景图
  &.tab-basic {
    background-image: url('https://amakano3.yorino.space/menu/config/bt_tabbasic.webp');
  }

  &.tab-sound {
    background-image: url('https://amakano3.yorino.space/menu/config/bt_tabsound.webp');
  }

  &.tab-voice {
    background-image: url('https://amakano3.yorino.space/menu/config/bt_tabvoice.webp');
  }

  &.tab-dialog {
    background-image: url('https://amakano3.yorino.space/menu/config/bt_tabdialog.webp');
  }

  &.tab-guide {
    background-image: url('https://amakano3.yorino.space/menu/config/bt_tabguide.webp');
  }
}
...
.bottom-btn {
  ...
  &.btn-default {
    ...
    background-image: url('https://amakano3.yorino.space/menu/config/bt_default.webp');
  ...
  &.btn-return {
    ...
    background-image: url('https://amakano3.yorino.space/menu/config/bt_return.webp');
  ...
  &.btn-title {
    ...
    height: 54.6px; // 42px * 1.3
    background-image: url('https://amakano3.yorino.space/menu/config/bt_title.webp');
  ...
  &.btn-end {
    ...
    height: 54.6px; // 42px * 1.3
    background-image: url('https://amakano3.yorino.space/menu/config/bt_end.webp');
