...
const menuIcons = [
  {
    name: 'skip',
    url: 'https://amakano3.yorino.space/menu/bt_skip.webp',
    width: 71,
    desc: '快进文本（未制作）',
  },
  {
    name: 'auto',
    url: 'https://amakano3.yorino.space/menu/bt_auto.webp',
    width: 68,
    desc: '自动阅读文本',
  },
  {
    name: 'prev',
    url: 'https://amakano3.yorino.space/menu/bt_selback.webp',
    width: 72,
    desc: '回到上个选项（未制作）',
  },
  {
    name: 'next',
    url: 'https://amakano3.yorino.space/menu/bt_selnext.webp',
    width: 74,
    desc: '前往下个选项（未制作）',
  },
  { name: 'voice', url: 'https://amakano3.yorino.space/menu/bt_voice.webp', width: 84, desc: '音乐设置' },
  {
    name: 'fav',
    url: 'https://amakano3.yorino.space/menu/bt_favo.webp',
    width: 62,
    desc: '进行语言收藏（未制作）',
  },
  {
    name: 'log',
    url: 'https://amakano3.yorino.space/menu/bt_blog.webp',
    width: 67,
    desc: '打开剧情回想',
  },
  {
    name: 'config',
    url: 'https://amakano3.yorino.space/menu/bt_config.webp',
    width: 92,
    desc: '打开设置界面',
  },
  {
    name: 'graph',
    url: 'https://amakano3.yorino.space/menu/bt_graph.webp',
    width: 81,
    desc: '打开甜蜜量表（未制作）',
  },
  {
    name: 'lock',
    url: 'https://amakano3.yorino.space/menu/bt_lock.webp',
    width: 32,
    desc: '固定系统菜单',
  },
  {
    name: 'close',
    url: 'https://amakano3.yorino.space/menu/bt_close.webp',
    width: 32,
    desc: '隐藏文本框',
  },
];
